...
<body class="bg-gray-50 dark:bg-gray-900 min-h-full transition-colors duration-200">
    ...
    <nav class="bg-white dark:bg-gray-800 shadow-sm border-b border-gray-200 dark:border-gray-700 transition-colors duration-200">
            ...
            <div class="flex justify-between h-16">
                ...
                <div class="hidden md:flex items-center space-x-1">
                    @auth
                        ...
                        {{-- Embarcaciones: TI y Dirección --}}
                        @if(auth()->user()->hasRole(['ti', 'direccion']))
                            <a href="{{ route('embarcaciones.index') }}"
                               class="px-3 py-2 rounded-md text-sm font-medium text-gray-700 dark:text-gray-300 hover:text-primary-600 dark:hover:text-primary-400 hover:bg-gray-50 dark:hover:bg-gray-700 transition-colors {{ request()->routeIs('embarcaciones.*') ? 'text-primary-600 dark:text-primary-400 bg-primary-50 dark:bg-primary-900/20' : '' }}">
                                Embarcaciones
                            </a>
                        @endif
        ...
        @auth
            <div id="mobile-menu"
                 class="md:hidden hidden border-t border-gray-200 dark:border-gray-700 bg-white dark:bg-gray-800 transition-colors duration-200">
                ...
                <div class="px-2 pt-2 pb-3 space-y-1">
                    ...
                    <a href="{{ route('prestamos.index') }}"
                       class="block px-3 py-2 rounded-md text-base font-medium text-gray-700 dark:text-gray-300 hover:text-primary-600 dark:hover:text-primary-400 hover:bg-gray-50 dark:hover:bg-gray-700 transition-colors {{ request()->routeIs('prestamos.*') ? 'text-primary-600 dark:text-primary-400 bg-primary-50 dark:bg-primary-900/20' : '' }}">
                        Préstamos
                    </a>

                    @if(auth()->user()->canManageFinanzas())
                        <a href="{{ route('orden-compra.index') }}"
                           class="block px-3 py-2 rounded-md text-base font-medium text-gray-700 dark:text-gray-300 hover:text-primary-600 dark:hover:text-primary-400 hover:bg-gray-50 dark:hover:bg-gray-700 transition-colors {{ request()->routeIs('orden-compra.*') ? 'text-primary-600 dark:text-primary-400 bg-primary-50 dark:bg-primary-900/20' : '' }}">
                            Órdenes de Compra
                        </a>
                    @endif
                    ...
                    @if(auth()->user()->canManageValeEPP())
                        <a href="{{ route('valepp.index') }}"
                           class="block px-3 py-2 rounded-md text-base font-medium text-gray-700 dark:text-gray-300 hover:text-primary-600 dark:hover:text-primary-400 hover:bg-gray-50 dark:hover:bg-gray-700 transition-colors {{ request()->routeIs('valepp.*') ? 'text-primary-600 dark:text-primary-400 bg-primary-50 dark:bg-primary-900/20' : '' }}">
                            Vales de EPP
                        </a>
                    @endif
                    ...
                    @if(auth()->user()->canManagePersonal())
                        <a href="{{ route('personal.index') }}"
                           class="block px-3 py-2 rounded-md text-base font-medium text-gray-700 dark:text-gray-300 hover:text-primary-600 dark:hover:text-primary-400 hover:bg-gray-50 dark:hover:bg-gray-700 transition-colors {{ request()->routeIs('personal.*') ? 'text-primary-600 dark:text-primary-400 bg-primary-50 dark:bg-primary-900/20' : '' }}">
                            Personal
                        </a>

                        <a href="{{ route('bajas.index') }}"
                           class="block px-3 py-2 rounded-md text-base font-medium text-gray-700 dark:text-gray-300 hover:text-primary-600 dark:hover:text-primary-400 hover:bg-gray-50 dark:hover:bg-gray-700 transition-colors {{ request()->routeIs('bajas.*') ? 'text-primary-600 dark:text-primary-400 bg-primary-50 dark:bg-primary-900/20' : '' }}">
                            Bajas
                        </a>

                        <a href="{{ route('cambios.index') }}"
                           class="block px-3 py-2 rounded-md text-base font-medium text-gray-700 dark:text-gray-300 hover:text-primary-600 dark:hover:text-primary-400 hover:bg-gray-50 dark:hover:bg-gray-700 transition-colors {{ request()->routeIs('cambios.*') ? 'text-primary-600 dark:text-primary-400 bg-primary-50 dark:bg-primary-900/20' : '' }}">
                            Cambios
                        </a>
                    @endif
                    ...
                    @if(auth()->user()->hasRole(['ti', 'direccion']))
                        <a href="{{ route('embarcaciones.index') }}"
                           class="block px-3 py-2 rounded-md text-base font-medium text-gray-700 dark:text-gray-300 hover:text-primary-600 dark:hover:text-primary-400 hover:bg-gray-50 dark:hover:bg-gray-700 transition-colors {{ request()->routeIs('embarcaciones.*') ? 'text-primary-600 dark:text-primary-400 bg-primary-50 dark:bg-primary-900/20' : '' }}">
                            Embarcaciones
                        </a>
                    @endif
                    ...
                    @if($canAccessProveedores)
                        <a href="{{ route('proveedores.index') }}"
                           class="block px-3 py-2 rounded-md text-base font-medium text-gray-700 dark:text-gray-300 hover:text-primary-600 dark:hover:text-primary-400 hover:bg-gray-50 dark:hover:bg-gray-700 transition-colors {{ request()->routeIs('proveedores.*') ? 'text-primary-600 dark:text-primary-400 bg-primary-50 dark:bg-primary-900/20' : '' }}">
                            Proveedores
                        </a>
                    @endif
