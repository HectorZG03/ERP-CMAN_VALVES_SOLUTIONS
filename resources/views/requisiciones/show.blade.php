                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <div class="bg-blue-50 dark:bg-blue-900/30 rounded-lg p-4 transition-colors duration-200">
                            <div class="flex items-center">
                                <svg class="w-8 h-8 text-blue-500 dark:text-blue-400 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 21V5a2 2 0 00-2-2H7a2 2 0 00-2 2v16m14 0h2m-2 0h-5m-9 0H3m2 0h5M9 7h1m-1 4h1m4-4h1m-1 4h1m-5 10v-5a1 1 0 011-1h2a1 1 0 011 1v5m-4 0h4"/>
                                </svg>
                                <div>
                                    <dt class="text-sm font-medium text-gray-500 dark:text-gray-400">Plataforma</dt>
                                    <dd class="text-lg font-semibold text-gray-900 dark:text-white">{{ $requisicion->plataforma }}</dd>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="bg-green-50 dark:bg-green-900/30 rounded-lg p-4 transition-colors duration-200">
                            <div class="flex items-center">
                                <svg class="w-8 h-8 text-green-500 dark:text-green-400 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <div class="bg-white dark:bg-gray-800 shadow sm:rounded-lg transition-colors duration-200">
                <div class="px-4 py-5 sm:p-6">
                    ...
                    <div class="bg-gray-50 dark:bg-gray-700 rounded-lg p-4 transition-colors duration-200">
                        <p class="text-gray-700 dark:text-gray-300 whitespace-pre-line">{{ $requisicion->comentario }}</p>
                    </div>
                </div>
            </div>
        ...
        <div class="space-y-6">
            ...
            <div class="bg-white dark:bg-gray-800 shadow sm:rounded-lg transition-colors duration-200">
                <div class="px-4 py-5 sm:p-6">
                    ...
                    <div class="text-center">
                        <div class="mx-auto h-20 w-20 rounded-full bg-purple-500 dark:bg-purple-600 flex items-center justify-center">
            ...
            <div class="bg-white dark:bg-gray-800 shadow sm:rounded-lg transition-colors duration-200">
                <div class="px-4 py-5 sm:p-6">
                    ...
                    <dl class="space-y-3">
                        <div>
                            <dt class="text-sm font-medium text-gray-500 dark:text-gray-400">Fecha de Requisición</dt>
            ...
            <div class="bg-white dark:bg-gray-800 shadow sm:rounded-lg transition-colors duration-200">
                <div class="px-4 py-5 sm:p-6">
                    ...
                    <div class="text-center">
                        <div class="mx-auto h-16 w-16 rounded-full {{ $requisicion->tipo_requerimiento === 'interno' ? 'bg-blue-100 dark:bg-blue-900/30' : 'bg-orange-100 dark:bg-orange-900/30' }} flex items-center justify-center transition-colors duration-200">
                            @if($requisicion->tipo_requerimiento === 'interno')
                        ...
                        <h4 class="mt-3 text-lg font-medium {{ $requisicion->tipo_requerimiento === 'interno' ? 'text-blue-900 dark:text-blue-300' : 'text-orange-900 dark:text-orange-300' }}">
