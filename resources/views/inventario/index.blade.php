        ...
        <div class="flex space-x-3">
            ...
            <div class="flex space-x-2">
                <a href="{{ route('inventario.export.pdf') }}" 
                   class="inline-flex items-center px-3 py-2 bg-red-600 dark:bg-red-700 hover:bg-red-700 dark:hover:bg-red-800 text-white text-sm font-medium rounded-md transition-colors duration-200">
                ...
                <div class="flex items-center">
                    ...
                    <div class="ml-5 w-0 flex-1">
                        <dl>
                            ...
                            <dd class="text-lg font-medium text-gray-900 dark:text-white">{{ $inventarios->total() }}</dd>
                        </dl>
                    </div>
                </div>
            </div>
        ...
        <div class="bg-white dark:bg-gray-800 overflow-hidden shadow rounded-lg border border-gray-200 dark:border-gray-700 transition-colors duration-200 cursor-pointer hover:shadow-md" 
            ...
            <div class="p-5">
                <div class="flex items-center">
                    ...
                    <div class="ml-5 w-0 flex-1">
                        <dl>
                            <dt class="text-sm font-medium text-gray-500 dark:text-gray-400 truncate">En Stock</dt>
                            <dd class="text-lg font-medium text-gray-900 dark:text-white">{{ $inventarios->where('existencia', '>', 0)->count() }}</dd>
                        </dl>
                    </div>
                </div>
            </div>
        ...
        <div class="bg-white dark:bg-gray-800 overflow-hidden shadow rounded-lg border border-gray-200 dark:border-gray-700 transition-colors duration-200 cursor-pointer hover:shadow-md" 
            ...
            <div class="p-5">
                <div class="flex items-center">
                    ...
                    <div class="ml-5 w-0 flex-1">
                        <dl>
                            <dt class="text-sm font-medium text-gray-500 dark:text-gray-400 truncate">Sin Stock</dt>
                            <dd class="text-lg font-medium text-gray-900 dark:text-white">{{ $inventarios->where('existencia', '<=', 0)->count() }}</dd>
                        </dl>
                    </div>
                </div>
        ...
        <div class="bg-white dark:bg-gray-800 overflow-hidden shadow rounded-lg border border-gray-200 dark:border-gray-700 transition-colors duration-200">
            <div class="p-5">
                <div class="flex items-center">
                    ...
                    <div class="ml-5 w-0 flex-1">
                        <dl>
                            <dt class="text-sm font-medium text-gray-500 dark:text-gray-400 truncate">Valor Total</dt>
                            <dd class="text-lg font-medium text-gray-900 dark:text-white">${{ number_format($inventarios->sum('precio_total'), 2) }}</dd>
                        </dl>
                    </div>
                </div>
            </div>
                            ...
                            <td class="px-6 py-4 whitespace-nowrap">
                                <div class="flex items-center">
                                    <div class="flex-shrink-0 h-10 w-10">
                                        <div class="h-10 w-10 rounded-lg bg-blue-500 dark:bg-blue-600 flex items-center justify-center">
                                ...
                                <div class="flex items-center space-x-2">
                                    ...
                                    @if(auth()->user()->canManageInventory())
                                        ...
                                        <a href="{{ route('inventario.edit', $inventario) }}" 
                                           class="inline-flex items-center px-2 py-1 bg-yellow-100 dark:bg-yellow-900/30 hover:bg-yellow-200 dark:hover:bg-yellow-900/50 text-yellow-800 dark:text-yellow-300 text-xs font-medium rounded-md transition-colors duration-200">
                                        ...
                                        <form method="POST" action="{{ route('inventario.destroy', $inventario) }}" 
                                            ...
                                            @method('DELETE')
                                            <button type="submit" 
                                                    class="inline-flex items-center px-2 py-1 bg-red-100 dark:bg-red-900/30 hover:bg-red-200 dark:hover:bg-red-900/50 text-red-800 dark:text-red-300 text-xs font-medium rounded-md transition-colors duration-200">
                                                <svg class="w-3 h-3 mr-1" fill="none" stroke="currentColor" viewBox="0 0 24 24">
